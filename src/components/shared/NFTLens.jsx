...
export default function NFTDemo({ data, ...props }) {
  ...
  if (!data) {
    return (
      <div {...props} className="w-full relative rounded-xl overflow-hidden max-w-md mx-auto bg-gradient-to-r from-[#1D2235] to-[#121318] p-4 my-10">
        <Rays />
        <Beams />
        <div className="relative z-10">
          <Lens hovering={hovering} setHovering={setHovering}>
            <img src="/img/wallpaper/default/img0.jpg" alt="NFT" className="w-full h-40 object-cover rounded-xl" />
          </Lens>
          <motion.div
            animate={{
              filter: hovering ? "blur(2px)" : "blur(0px)",
            }}
            className="py-4 relative z-20 space-y-3"
          >
            ...
            <p className="text-neutral-200 line-clamp-2 hover:line-clamp-none transition-all duration-300">
  ...
  return (
    <div {...props} className="w-full relative rounded-xl overflow-hidden max-w-md mx-auto bg-gradient-to-r from-[#1D2235] to-[#121318]  p-8 my-10">
      ...
      <div className="relative z-10">
        <Lens hovering={hovering} setHovering={setHovering}>
          <img src={token.current_collection.uri} alt="NFT" className="w-full h-40 object-cover rounded-xl" />
        </Lens>
        <motion.div
          animate={{
            filter: hovering ? "blur(2px)" : "blur(0px)",
